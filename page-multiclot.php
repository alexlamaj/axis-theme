    ...
    <div id="demoModal" class="demo-modal" aria-hidden="true">
        ...
        <div class="demo-modal-card">
            ...
            <form id="demoRequest" class="demo-form">
                ...
                <?php wp_nonce_field('demo_request_nonce', 'security'); ?>
                <input type="hidden" name="action" value="submit_demo_request">
                ...
                <div class="form-item">
                    ...
                    <label class="flabel" for="demo_message"><?php _e('Message', 'axis-theme'); ?></label>

                    <input class="finput" style="width: calc(100% - 25px);" type="text" id="demo_message" name="message_text">
