...
<div class="header-drawer">
        ...
        <div class="header-drawer-content">
            ...
            <div style="display:flex; flex-direction:column; gap: 15px; margin: 80px 0px 0px 40px;">
            ...
            <a href="<?php echo esc_url(home_url('/contact-us/')); ?>" class="btn-outline" style="margin: 0px 0px 80px 40px;"><?php _e('Contact Us', 'axis-theme'); ?></a>
